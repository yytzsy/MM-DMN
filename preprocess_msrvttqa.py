...
def main():
    ...
    # os.makedirs('/mnt/data/yuanyitian/videoQA/dmn/data/msrvtt_qa')

    extract_vgg_video_feature(os.path.join(sys.argv[1], ''),
                         '/mnt/data/yuanyitian/videoQA/dmn/data/msrvtt_qa/video_feature_20_conv5_part2.h5')

    # extract_video_feature(os.path.join(sys.argv[1], 'video'),
    #                      '/mnt/data/yuanyitian/videoQA/dmn/data/msrvtt_qa/video_feature_20_conv5.h5')
